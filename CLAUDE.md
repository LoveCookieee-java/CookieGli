...
[DEPENDENCY_MATRIX]
external: cookiegli
hotspots: cookiegli_core.mcp_server(fan_in:8), ast_scanner(fan_in:6), cookiegli_core.ast_scanner(fan_in:6), genome_engine(fan_in:5), cookiegli_core.genome_engine(fan_in:5)
...
classes:
  ...
  • class BoostEngine [methods: __init__, close, init_project, synthesize_task_context] [src/cookiegli_core/boost_engine.py:60] - CookieGli Boost Engine for 2026 Frontier
...
functions:
  • def cmd_boost(args) [cli/cookiegli.py:52]
...
## Developer Preferences & Invariants
